...
public:
    //double x1 = 872, y1 = 83;
    //double x2 = 1100 , y2 = 13;
    //double x3 = 1062 , y3 = 163;
    //double x4 = 920 , y4 = 291;
    double x = 1100 , y = 291;
    double prevY = 0;
    ...
    void display()
    {
        glBegin(GL_QUADS);
            ...
            glVertex2f(822.0f,  133.0f);
            glVertex2f( 1150.0f,  63.0f);
            glVertex2f(1122.0f , 213.0f);
            glVertex2f(870.0f, 241.0f);
        glEnd();
    }
...
int main(void) {
    ...
    window = glfwCreateWindow(1200, 800, "Interaction", NULL, NULL);
    if (!window){
        glfwTerminate();
    }
